...
export default function createStyles(colors) {
  return StyleSheet.create({
    ...
    spinnerRing: {
      ...
      borderRadius: 18,
      borderWidth: 3,
      borderColor: colors.isDark ? '#1A3959' : colors.orange[200],
    ...
    cancelBtn: {
      borderWidth: 1.5,
      borderColor: colors.isDark ? 'rgba(239, 68, 68, 0.4)' : '#F5C4C4',
      backgroundColor: colors.card,
      borderRadius: 16,
      paddingVertical: 16,
      alignItems: 'center',
    ...
    warnIconWrap: {
      ...
      height: 44,
      borderRadius: 22,
      backgroundColor: colors.isDark ? 'rgba(217, 119, 6, 0.18)' : colors.amber[100],
      alignItems: 'center',
      justifyContent: 'center',
      marginRight: 12,
      marginTop: 2,
