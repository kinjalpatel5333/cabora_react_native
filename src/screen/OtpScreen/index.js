    ...
    const timeout = setTimeout(() => {
      navigation.replace('SetupAccount', {
        ...
        userId:
          ...
          verifiedUser?.userId,
        user: verifiedUser,
        isOnBoarding: verifiedResponseData?.isOnBoarding,
        isNewUser: verifiedResponseData?.isNewUser,
        responseData: verifiedResponseData,
      });
    }, VERIFY_REDIRECT_MS);
    return () => clearTimeout(timeout);
  }, [navigation, phone, countryCode, verified, verifiedUser, verifiedResponseData]);
